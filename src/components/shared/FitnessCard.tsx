...
const FitnessCard = ({ fitData }: FitnessCardProps) => {
  ...
  return (
    ...
    >
      <article className="group overflow-hidden rounded-2xl border border-[#25282e] bg-[#15171c] transition duration-200 hover:border-[#aaff00] hover:bg-[#17191e] active:scale-[0.99]">
        {/* Image */}
